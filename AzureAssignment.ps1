...
.DESCRIPTION
a Resource Group with the name GRP-SentiaWE7 in West Europe
a Storage Account with name sentiaazurestorage123 in the above created Resource Group, using encryption and an unique name, starting with the prefix 'sentia'
...
$ResourceGroup = "GRP-SentiaWE7"
$resourceGroupLocation = "West Europe"
$VirtualNetwork = "SentiaVirtualNetwork"
$storageAccountName = "sentiaazurestorage123"
...
$assignment = New-AzureRMPolicyAssignment -Name "allowed-resourcetypesassignment" -listOfResourceTypesAllowed $ParameterFilePath -PolicyDefinition $definition -Scope $rmgroup.resourceID
$assignment
